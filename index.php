...
<main id="main" class="accueil conteneur">
    ...
    <div class="partie partie__2">
        ...
        <div class="etudiants">
            ...
            <a href="#" class="etudiants__liens--etuUnJour lien">Étudiant d'un jour</a>
            <a href="#" class="etudiants__liens--inscription lien__bouton bouton__full">Inscription</a>
        </div>
        ...
        <div class="employeurs">
            ...
            <div class="employeurs__diplomes">
                ...
                <a href="#" class="employeurs__diplomes--lien lien_corail lien">Diplômés</a>
            </div>
            <div class="employeurs__stages">
                <p class="employeurs__stages--texte">
                    <?= $part2_employeur["texte_stages"] ?>
                </p>
                <a href="" class="employeurs__stages--lien lien_corail lien">Stages</a>
            </div>
        </div>
    </div>
    ...
    <div class="partie partie__4">
        ...
        <div class="item inscriptions">
            ...
            <a href="" class="inscriptions__lien lien__bouton bouton__full">S'inscrire</a>
        </div>
        ...
        <div class="item quiz">
            ...
            <a href="#" class="quiz__lien lien__bouton lien">Faire le quiz</a>
        </div>
    </div>
            ...
            <?php for($i=0; $i<2; $i++) {?>
                <div class="unTemoignage">
                    <div class="row">
                        ...
                        <a href="<?= get_field("url_entreprise", $temoignages[$i]->ID)?>"><?= get_field("entreprise", $temoignages[$i]->ID)?></a>
                        </span>
                        </div>
                    </div>
